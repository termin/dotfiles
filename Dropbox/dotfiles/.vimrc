...
nnoremap <C-M-Left> :<C-u>execute 'tabmove' tabpagenr() -2<CR>
nnoremap <C-M-Right> :<C-u>execute 'tabmove' tabpagenr()<CR>
" nnoremap <Left> :<C-u>execute 'tabmove' tabpagenr() -2<CR>
" nnoremap <Right> :<C-u>execute 'tabmove' tabpagenr()<CR>
nmap g1 :<C-u>tabfirst<CR>
nmap g9 :<C-u>tablast<CR>
